        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelephoneForCustomers = table.Column<string>(nullable: true),
                    NameOfThePage = table.Column<string>(nullable: true),
                    DeletedOn = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgsPaths = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersCarsFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersCarsFavorites_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersCarsFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersCarsFavorites_CarId",
                table: "UsersCarsFavorites",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersCarsFavorites_IsDeleted",
                table: "UsersCarsFavorites",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_UsersCarsFavorites_UserId",
                table: "UsersCarsFavorites",
                column: "UserId");
        }
